...
)
{
  ...
  status = rtems_task_set_affinity(
    Task_1_id,
    sizeof(cpuset),
    &cpuset
  );
  check_rtems_status(status, 0, "rtems_task_set_affinity of Task_1");

  status = rtems_task_start( Task_1_id, Task_1, (rtems_task_argument)1 );
  ...
  check_rtems_status(status, 0, "rtems_task_set_affinity of Task_2");

  status = rtems_task_start( Task_2_id, Task_1, (rtems_task_argument)2 );
