...
const uint8_t *rtems_lwip_sysdefs_sockaddr_in6_get_sin6_addr_ptr(const void *sockaddr);
uint32_t rtems_lwip_sysdefs_sockaddr_in6_get_sin6_flowinfo(const void *sockaddr);
uint32_t rtems_lwip_sysdefs_sockaddr_in6_get_sin6_scope_id(const void *sockaddr);

void rtems_lwip_sysdefs_sockaddr_set_len(void *sockaddr, int len);
void rtems_lwip_sysdefs_sockaddr_set_family(void *sockaddr, int family);
void rtems_lwip_sysdefs_sockaddr_in_set_sin_port(void *sockaddr, uint16_t port);
void rtems_lwip_sysdefs_sockaddr_in_set_sin_addr(void *sockaddr, uint32_t addr);
void rtems_lwip_sysdefs_sockaddr_in6_set_sin6_port(void *sockaddr, uint16_t port);
void rtems_lwip_sysdefs_sockaddr_in6_set_sin6_flowinfo(void *sockaddr, uint32_t flowinfo);
void rtems_lwip_sysdefs_sockaddr_in6_set_sin6_scope_id(void *sockaddr, uint32_t scope_id);
